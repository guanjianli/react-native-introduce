...
import DoneButton from "./style/DoneButton";
import SkipButton from "./style/SkipButton";
import RenderDots from "./style/Dots";
...
export default class Index extends Component {
    constructor(props) {
        ...
        this.styles = StyleSheet.create(Object.assign({}, defaultStyles, props.customStyles));
    ...
    shadeStatusBarColor(color, percent) {
        ...
        const finalColor = (0x1000000 + (Math.round((theme - red) * percentage) + red) * 0x10000 + (Math.round((theme - green) * percentage) + green) * 0x100 +
